...
-- -----------------------------------------------------
-- Table `forkyeah`.`recipe`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `forkyeah`.`recipe` (
  `idrecipes` INT NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  `instructions` TEXT(65000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `forkyeah`.`user` (
  ...
  CONSTRAINT `fk_user_recipes1`
    ...
    REFERENCES `forkyeah`.`recipe` (`idrecipes`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
